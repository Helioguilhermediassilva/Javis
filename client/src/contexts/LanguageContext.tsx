...
const messages = {
  pt: {
    ...
    telegram: {
      ...
      connectDescription: "Abra o bot oficial, use o código de vinculação abaixo e confirme a conexão. Você não precisa criar um bot ou compartilhar tokens.",
      ...
      setupStep2: "Gere um código de vinculação nesta página.",
      setupStep3: "Envie o código ao bot e confirme a conexão.",
  ...
  en: {
    ...
    telegram: {
      ...
      connectDescription: "Open the official bot, use the link code below and confirm the connection. You do not need to create a bot or share tokens.",
      ...
      setupStep2: "Generate a linking code on this page.",
      setupStep3: "Send the code to the bot and confirm the connection.",
  ...
  es: {
    ...
    telegram: {
      ...
      connectDescription: "Abre el bot oficial, usa el código de vinculación y confirma la conexión. No necesitas crear un bot ni compartir tokens.",
      ...
      setupStep2: "Genera un código de vinculación en esta página.",
      setupStep3: "Envía el código al bot y confirma la conexión.",
      officialBot: "Bot oficial",
