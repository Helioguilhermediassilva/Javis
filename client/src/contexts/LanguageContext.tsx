...
const messages = {
  pt: {
    ...
    home: {
      ...
      promptHint: "Shift + Enter para nova linha",
      actionAttach: "Anexar arquivo",
      actionMicrophone: "Microfone",
      actionFullscreen: "Tela cheia",
      actionNewConversation: "Nova conversa",
    ...
    location: {
      ...
      selectState: "Selecione o estado ou província",
      selectCity: "Selecione a cidade",
      loadingCountries: "Carregando países...",
      loadingStates: "Carregando estados/províncias...",
      ...
      noStates: "Este país não possui estados cadastrados",
      loadError: "Não foi possível carregar as localidades.",
      retry: "Tentar novamente",
      dataSource: "Dados de localidades: Countries States Cities Database",
  ...
  en: {
    ...
    home: {
      ...
      promptHint: "Shift + Enter for a new line",
      actionAttach: "Attach file",
      actionMicrophone: "Microphone",
    ...
    location: {
      ...
      noStates: "This country has no states in the catalog",
      loadError: "Could not load locations.",
      retry: "Retry",
      dataSource: "Location data: Countries States Cities Database",
  ...
  es: {
    ...
    home: {
      ...
      promptHint: "Shift + Enter para una nueva línea",
      actionAttach: "Adjuntar archivo",
      actionMicrophone: "Micrófono",
      actionFullscreen: "Pantalla completa",
      actionNewConversation: "Nueva conversación",
    ...
    location: {
      ...
      selectState: "Selecciona el estado o provincia",
      selectCity: "Selecciona la ciudad",
      loadingCountries: "Cargando países...",
      loadingStates: "Cargando estados/provincias...",
      loadingCities: "Cargando ciudades...",
      selectCountryFirst: "Selecciona primero un país",
      selectStateFirst: "Selecciona primero un estado",
      noStates: "Este país no tiene estados registrados",
      loadError: "No se pudieron cargar las localidades.",
      retry: "Reintentar",
      dataSource: "Datos de localidades: Countries States Cities Database",
